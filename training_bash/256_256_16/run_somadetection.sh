...
neptune_project="CellSegmentation/SomaSegmentation"

# model parameters
image_input_size=256_256_16
encoder_patch_size=8_8_2
encoder_emb_dim=64 # should be image_input_size[0]//8 * image_input_size[1]//8 * image_input_size[2]//8
encoder_depth=20
encoder_mlp_ratio=4
